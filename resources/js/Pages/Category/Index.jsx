  ...
  return (
    ...
    header={
      <div className="flex justify-between categories-center relative">
        <h2 className="font-semibold text-2xl text-blue-600 dark:text-gray-200 leading-tight">Category</h2>
        {success && (
                 <Alert
     ...
     <Link href={route('category.create')} className="flex flex-nowrap gap-2 font-semibold bg-green-500 py-2 px-4 text-white rounded shadow transition-all hover:bg-green-700">
                 Add New
                  ...
                  <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                      <thead className="text-xs text-gray-700 uppercase  bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b-2 border-gray-500">
                        ...
                        sort_direction={queryParams.sort_direction}
                         ...
                         <TableHeading  className="pr-10"   name="description"sort_field={queryParams.sort_field}sort_direction={queryParams.sort_direction}
                         sortChanged={sortChanged}>Description</TableHeading>
                          <TableHeading className="pr-10"   name="sku_prefix"sort_field={queryParams.sort_field}sort_direction={queryParams.sort_direction}
                      ...
                      <tbody>
                        {categories.data.map((category)=>(
                             <tr className="bg-white border-b text-gray-600 dark:bg-gray-800 dark:border-gray-700" key={category.id}>
                             ...
                             <td className="px-3 py-2">{category.sku_prefix}</td>
                             <td className="px-3 py-2 text-nowrap">
                              <td></td>
                                  <div className="flex">
                                        <Link href={route('category.edit', category.id)} className="p-2 font-medium text-blue-600 hover:bg-blue-600 hover:text-white hover: rounded-full hover:underline mx-1"> 
