          ...
          <div className="max-w-5/6">
              ...
              <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                  ...
                  <div className="w-full flex flex-row justify-between items-center mb-2">
                    <div>
                      <Link href={route('brand.create')} className="flex flex-nowrap gap-2 font-semibold bg-blue-500 py-2 px-4 text-white rounded shadow transition-all hover:bg-blue-700">
                  ...
                  <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                      ...
                      <tbody>
                        {brands.data.map((brand)=>(
                             ...
                             <td className="py-2 ">
                              {brand.description ??  "No Brand Description "}
                            </td>
                             <td className="py-2">
                                  <div className="flex flex-row justify-end items-center">
                                        <Link href={route('brand.edit', brand.id)} className="text-blue-600 mx-1 hover:text-gray-600"> 
