                ...
                <div className="flex flex-row gap-2">
                    ...
                    <div className="w-2/3 grid grid-cols-4 gap-2 text-center content-start">
                        ...
                        <div className="col-span-1 flex flex-row bg-white overflow-hidden shadow-sm sm:rounded-lg content-center items-center justify-center gap-2 p-4">
                            <div className="w-12">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" id="Module--Streamline-Sharp"><desc>Module Streamline Icon: https://streamlinehq.com</desc><g id="module--cube-code-module-programming-plugin"><path id="Vector 1377" fill="#2859c5" d="M1 5.5 12 1l11 4.5v13L12 23 1 18.5v-13Z" stroke-width="1"></path><path id="Union" fill="#8fbffa" fillRule="evenodd" d="M11.25 9.693 1 5.5 12 1l11 4.5 -10.25 4.193v13L12 23l-0.75 -0.307v-13Z" clip-rule="evenodd" stroke-width="1"></path></g></svg>
                            </div>
                        ...
                        <div className="col-span-1 flex flex-row bg-white overflow-hidden shadow-sm sm:rounded-lg content-center items-center justify-center gap-2 p-4">
                            <div className="w-12">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" id="Shipping-Box-1--Streamline-Sharp"><desc>Shipping Box 1 Streamline Icon: https://streamlinehq.com</desc><g id="shipping-box-1--box-package-label-delivery-shipment-shipping"><path id="Union" fill="#8fbffa" fillRule="evenodd" d="M23.76 0.24H0.24V23.76H23.76V0.24Z" clip-rule="evenodd" stroke-width="1"></path><path id="Intersect" fill="#2859c5" fillRule="evenodd" d="M8.1712 0.24V10.3591L12 7.6242L15.8288 10.3591V0.24H8.1712Z" clip-rule="evenodd" stroke-width="1"></path><path id="Vector 3 (Stroke)" fill="#2859c5" fillRule="evenodd" d="M19.1107 20.4781H13.6409V18.8372H19.1107V20.4781Z" clip-rule="evenodd" stroke-width="1"></path></g></svg>
                            </div>
                            <div className="text-gray-900 text-left ml-2">
                                <h3 className="text-slate-700 font-light text-sm">
                                    Categories
                            ...
                            {itemsByLocation.map((item, index) => (
                                <tr key={index}>
                                    <td className="px-5 py-2 border-b border-gray-200 bg-white text-sm">
                                        <p className="text-gray-900 whitespace-no-wrap">{item.location_name}</p>
                                    </td>
                                    <td className="px-5 py-2 border-b border-gray-200 bg-white text-sm">
                                        <p className="text-gray-900 whitespace-no-wrap">{item.total_quantity}</p>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
...
<div className="group relative">
            ...
            <div className="px-5 pt-2 flex flex-row gap-2">
