...
// console.log("hello" + result);
        const onSubmitItem = (e) =>{
            ...
            alert("suceess")
            // post(route("itemMrr.store"), data, {
            //     onSuccess: () => console.log('Item submitted successfully'),
            //     onError: (errors) => console.error('Item submission error', errors),
            // });
        }
                        ...
                        className="p-4 sm:p8  bg-white dark:bg-gray-800 shadow sm:rounded-lg" action="">
                           <div className="flex">
                            ...
                            <div>
                                ...
                                <Link href={route('itemMrr.create')}
