                            ...
                            {deliverabless.data.map((deliverable)=>(
                              <tr className="bg-white border-b text-gray-600 dark:bg-gray-800 dark:border-gray-700" key={deliverable.id}>
                                  ...
                                  <td className="px-3 py-2 text-nowrap">
                                          <div className="flex">
                                              <Link href={route('deliverables.show', deliverable.id)} className="p-2 font-medium text-blue-600 hover:bg-blue-600 hover:text-white hover: rounded-full hover:underline mx-1"> 
