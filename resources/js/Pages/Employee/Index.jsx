...
export default function Index({auth, employees, queryParams = null, success}) {
...
const deleteEmployee = (employee) => {
  ...
  //   user={auth.user}
  //   header={
  //     <div className="flex justify-between employees-center">
  //       <h2 className="font-semibold text-2xl text-blue-600 dark:text-gray-200 leading-tight">Employees</h2>
  //       <Link href={route('employee.create')} className="flex flex-nowrap gap-2 font-semibold bg-green-500 py-2 px-4 text-white rounded shadow transition-all hover:bg-green-700">
  //                Add New
  ...
  //                        sortChanged={sortChanged}>Department</TableHeading>
  ...
  //                            <tr className="bg-white border-b text-gray-600 dark:bg-gray-800 dark:border-gray-700" key={employee.id}>
  ...
  //                            <td className="px-3 py-2 ">{employee.remarks}</td>
  //                            <td className="px-3 py-2 text-nowrap">
  //                             <td></td>
  //                               <div className="flex">
  //                                     <Link href={route('employee.edit', employee.id)}  className="p-2 font-medium text-blue-600 hover:bg-blue-600 hover:text-white hover: rounded-full hover:underline mx-1"> 
  ...
  header={
    <div className="flex justify-between items-center relative">
      <h2 className="font-semibold text-2xl text-blue-600 dark:text-gray-200 leading-tight">Employee</h2>
    ...
    <div className="py-5">
        ...
        <div className="max-w-5/6">
            ...
            <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div>
                  <Link href={route('employee.create')} className="flex flex-nowrap gap-2 font-semibold bg-blue-500 py-2 px-4 text-white rounded shadow transition-all hover:bg-blue-700">
                      ...
                      {employees.data.map((employee)=>(
                           ...
                           <td className="py-2">
                                <div className="flex flex-row justify-end items-center">
                                      <Link href={route('employee.edit', employee.id)} className="text-blue-600 mx-1 hover:text-gray-600"> 
