...
export default function Create({auth,existingItems, receiving,mrr_item_ids,items}){
 ...
 const {data, setData, post ,errors,processing} = useForm({
    ...
    console.log(data)
    const [databaseItemIds, setDatabaseItemIds] = useState(Array.isArray(existingItems) ? existingItems : []);
    ...
    useEffect(() => {
      ...
      const handleAddSelect = (e) => {
        ...
        const newSelectedItemIds = selectedItemIds.filter(id => !databaseItemIds.includes(id, 10));
                      ...
                      <div className="mt-20">
                            <table className="min-w-full bg-white">
                              ...
                              {databaseItemIds && databaseItemIds.length >= 0 && ( 
                                 <tbody>
                                    {databaseItemIds.map((selectedItem,index) => {
                                        if (selectedItem) {
                                        return (
