...
export default function Show({auth, receiving,reference_no,receiving_item_ids, category,onlySoftDeletedReceivings,tryDeleted, queryParams, success}){
    ...
    return(
        ...
        header={
            ...
            {`Receiving "${receiving.id}" `}
             ...
             <Link href={route('receiving.edit', receiving.id)} className="bg-green-500 py-1 px-3 text-white rounded shadow transition-all hover:bg-green-600">
            Edit
             </Link>
            ...
            <div>
                ...
                <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg col-span-2 ">
                        ...
                        <dl className="p-6 text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            ...
                            {/* <span className="text-2xl font-semibold ">{receiving.name}</span> */}
                            </div>
                ...
                <div className="bg-white  dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg ml-2 col-span-1">
                    <dl className="p-6 text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            ...
                            <dt className="mb-1 text-gray-500 text-md dark:text-gray-400">REFERENCE NUMBER : </dt>
                            <dd className="text-lg font-light uppercase ml-2">{receiving.receiving_item.reference_no}</dd>
                            </div>

                            <div className="flex flex-col pb-3 mt-2">
                            <dt className="mb-1 text-gray-500 text-md dark:text-gray-400"> RECEIVING ITEM ID: </dt>
                            <dd className="text-lg font-light"> {receiving.receiving_item.id}</dd>
                            </div>
{/* 
                            ...
                            <dd className="text-lg font-light">{receiving.location.name}</dd>
                            </div>
                            ...
                            <dd className="text-lg font-light">{receiving.employee.name}</dd>
                            </div>         */}
                              ...
                              {receiving_item_ids.map((receiving_item_id)=>(
                                   <tr className="bg-white border-b text-gray-600 dark:bg-gray-800 dark:border-gray-700" key={receiving_item_id.id}>
                                      ...
                                      <th className="px-3 py-2 text-gray-600 text-nowrap hover:underline">
                                        <Link href={route('item.show', receiving.id)}>
