          ...
          <div className="max-w-5/6">
              ...
              <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                  ...
                  <div className="w-full flex flex-row justify-between items-center mb-2">
                    <div>
                      <Link href={route('location.create')} className="flex flex-nowrap gap-2 font-semibold bg-blue-500 py-2 px-4 text-white rounded shadow transition-all hover:bg-blue-700">
                  ...
                  <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                      <thead className="text-xs text-gray-700 uppercase  bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b-2 border-gray-500">
                        ...
                        sort_direction={queryParams.sort_direction}
                         ...
                         <TableHeading  className="pr-10"  
                          name="company"
                          sort_field={queryParams.sort_field}
                          sort_direction={queryParams.sort_direction}
                         sortChanged={sortChanged}
                         >Company</TableHeading>
                        ...
                        {locations.data.map((location)=>(
                             ...
                             <td className="py-2">
                                  <div className="flex flex-row justify-end items-center">
                                        <Link href={route('location.edit', location.id)} className="text-blue-600 mx-1 hover:text-gray-600"> 
